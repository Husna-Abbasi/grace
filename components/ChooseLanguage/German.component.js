...
import German_Flag from "../../public/German-Flag.jpg"
    ...
    return (<>
            <div className="spanishMain bg-white rounded-md overflow-hidden mt-5">
                <div className="spanishMain w-[100%] p-10 flex justify-center items-center bg-white">
                    <div className="spanishLeft w-[50%]">
                        <Image src={German_Flag} alt="Flag" className="rounded-lg"/>
                    </div>
                    <div className="spanishRight ml-14">
                        ...
                        <p className="mb-7 text-sm font-thin text-black">
                            Learn German with Flying Languages by watching language learning
