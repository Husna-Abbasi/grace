...
import Brazilian_flag from "../../public/Brazilian-Flag-1.jpg"
import Image from "next/image";
function PortugueseComponent() {
    return (<>
            <div className=" bg-white rounded-md overflow-hidden mt-5">
                <div className="w-[100%] p-10 flex justify-center items-center bg-white">
                    <div className="w-[50%]">
                        <Image src={Brazilian_flag} alt="Flag" className="rounded-lg"/>
                    </div>
                    <div className="spanishRight ml-14">
                        ...
                        <p className="mb-7 text-sm font-thin text-black">
                            Learn Portuguese with Flying Languages by watching language learning
...
export default PortugueseComponent;
