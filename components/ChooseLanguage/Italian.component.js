...
import Italian_flag from "../../public/Italian-Flag-2-1.jpg"
import Image from "next/image";
function ItalianComponent() {
    return (<>
            <div className="spanishMain bg-white rounded-md overflow-hidden mt-5">
                <div className="spanishMain w-[100%] p-10 flex justify-center items-center bg-white">
                    <div className="w-[50%]">
                        <Image src={Italian_flag} alt="Flag" className="rounded-lg"/>
                    </div>
                    <div className="spanishRight ml-14">
                        <h1 className="text-3xl mb-3 font-bold text-[#5d85ad]">
                            Italian Resources
                        </h1>
                        <p className="mb-7 text-black text-sm font-thin">
                            Learn Italian with Flying Languages by watching language learning
